...
export default function Login() {
  ...
  return (
    <div className="relative">
      ...
      <div className="flex items-center justify-center bg-gradient-to-r from-purple-500 to-cyan-500 p-4 z-40">
        <Card className="w-full max-w-lg bg-[#ffffffd5]  text-gray-800 relative z-50">
