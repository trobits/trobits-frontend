...
//       // Check if response.error exists and has data
//       if (response.error && ((response as { error: { data: any } }).error.data)) {
//         const errorMessage = (response as { error: { data: { message: string } } }).error.data.message;
//         console.log(errorMessage); // Now you can safely access the message
//       } else {
//         console.error("Error response structure is unexpected or missing 'data'");
//       }
//       // handle error
//       if (response.error) {
