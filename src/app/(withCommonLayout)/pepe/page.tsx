...
const PepeHeader = () => (
    <div className="text-center mb-8">
        ...
        <p className="text-gray-400 text-lg mb-6">
            Comprehensive PEPE market analysis and insights
        </p>
...
const ArticleFeed = () => {
    ...
    React.useEffect(() => {
        const fetchNews = async () => {
            setLoading(true);
            try {
                const res = await fetch(`/api/crypto-news/coinDetailNews?coin=PEPE&page=1&items=20`);
                if (!res.ok) throw new Error("Failed to fetch PEPE news");
            ...
            <div className="bg-gray-950/80 border border-gray-800/60 rounded-2xl p-6 shadow-2xl">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-400">Latest Pepe updates</p>
                    </div>
                </div>
