            ...
            <div className="flex flex-col items-center gap-1">
              ...
              <div className="text-center w-full">
                ...
                <div className="bg-slate-700/50 p-1 rounded-lg">
                  ...
                  <p className="text-xs text-slate-400">(25% of {printrendyBaseCommission}%)</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col items-center gap-1">
              ...
              <div className="text-center w-full">
                ...
                <div className="bg-slate-700/50 p-1 rounded-lg">
                  ...
                  <p className="text-xs text-slate-400">(25% of $40.00)</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col items-center gap-1">
              ...
              <div className="text-center w-full">
                ...
                <div className="bg-slate-700/50 p-1 rounded-lg">
                  ...
                  <p className="text-xs text-slate-400">(25% of {ursimeBaseCommission}%)</p>
                </div>
              </div>
            </div>
          </div>
