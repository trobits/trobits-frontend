...
//             <article className="max-w-5xl mx-auto bg-[#ffffff] border-4 border-cyan-500 text-black tracking-wide leading-9 shadow-lg rounded-lg overflow-hidden">
...
//                     <h1 className="text-3xl sm:text-4xl font-bold text-cyan-600 text-center mb-6">{article?.title}</h1>
