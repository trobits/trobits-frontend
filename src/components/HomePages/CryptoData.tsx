...
const CoinColumn = ({ cryptoData, index, isLast }) => {
  ...
  return (
      <>
        <div className="flex-1 p-4 hover:bg-gray-900/20 transition-all duration-300 group">
          ...
          <div className="mb-6">
            <div className="bg-gray-900/40 border border-gray-800/50 rounded-xl p-3">
              <div ref={widgetRef} className="w-full h-[60px]" />
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-br from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-xl p-4">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium text-orange-300">1 Day Burn</span>
              </div>
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-xl p-4">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium text-purple-300">Lifetime Burn</span>
              </div>
              <div className="text-center text-lg font-bold text-white">
        ...
        {/* Vertical Divider */}
        {!isLast && (
            <div className="w-px bg-gray-800/50 my-4" />
        )}
      </>
  );
};
