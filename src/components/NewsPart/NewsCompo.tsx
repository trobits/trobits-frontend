...
//   // Function to get the next ad (zigzag pattern)
//   const getNextAds = (chunkIndex: number) => {
//     return <AdBanner key={`ad-${chunkIndex}`} />;
//   };

//   // Function to split articles into chunks of 3 (changed from 4)
...
//   const articleChunks = chunkArray(allBlogs.slice(0, 9), 3);
